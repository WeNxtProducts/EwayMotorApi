...
public interface EServiceMotorDetailsRepository  extends JpaRepository<EserviceMotorDetails,EserviceMotorDetailsId > , JpaSpecificationExecutor<EserviceMotorDetails> {
	...
	List<EserviceMotorDetails> findByRequestReferenceNoOrderByRiskIdDesc(String requestReferenceNo);

	List<EserviceMotorDetails> findByRequestReferenceNoAndStatusNotIn(String requestReferenceNo,
			List<String> statusesNot);

	List<EserviceMotorDetails> findByCompanyIdAndProductIdAndChassisNumber(String companyId, String productId,

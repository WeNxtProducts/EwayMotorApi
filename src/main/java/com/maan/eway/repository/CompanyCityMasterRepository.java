...
public interface CompanyCityMasterRepository  extends JpaRepository<CompanyCityMaster,CompanyCityMasterId > , JpaSpecificationExecutor<CompanyCityMaster> {
	...
	Long countByCityIdAndStateIdAndCountryIdAndStatusAndEffectiveDateStartLessThanEqual(Integer cityId,
			String stateId, String countryId, String status, Date today);

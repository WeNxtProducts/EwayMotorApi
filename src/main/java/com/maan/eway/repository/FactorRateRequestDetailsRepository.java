...
public interface FactorRateRequestDetailsRepository  extends JpaRepository<FactorRateRequestDetails,FactorRateRequestDetailsId > , JpaSpecificationExecutor<FactorRateRequestDetails> {
	...
	Long countByRequestReferenceNoAndProductIdAndSectionIdNotIn(String requestReferenceNo, Integer valueOf,
			List<Integer> sectionIds);

	@Transactional
	void deleteByRequestReferenceNoAndProductIdAndSectionIdNotIn(String requestReferenceNo, Integer valueOf,
			List<Integer> sectionIds);

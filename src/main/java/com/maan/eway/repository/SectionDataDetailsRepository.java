...
public interface SectionDataDetailsRepository  extends JpaRepository<SectionDataDetails,SectionDataDetailsId > , JpaSpecificationExecutor<SectionDataDetails> {
	...
	List<SectionDataDetails> findByQuoteNoAndRiskId(String quoteNo, Integer riskId);

	List<SectionDataDetails> findBySectionIdAndQuoteNo(String sectionId, String sectionId2);

	List<SectionDataDetails> findByRequestReferenceNo(String reqno);

...
public interface LoginBranchMasterRepository  extends JpaRepository<LoginBranchMaster,LoginBranchMasterId > , JpaSpecificationExecutor<LoginBranchMaster> {
	...
	LoginBranchMaster findByLoginIdAndBrokerBranchCodeAndCompanyIdAndBranchCode(String createdBy, String brokerbranchcode,
			String companyId,String branchcode);

	List<LoginBranchMaster> findByAgencyCodeOrderByBrokerBranchCodeAsc(Integer brokerCode);

	LoginBranchMaster findByAgencyCodeAndBrokerBranchCodeAndCompanyId(Integer brokerCode, String brokerBranchCode,
			String companyId);

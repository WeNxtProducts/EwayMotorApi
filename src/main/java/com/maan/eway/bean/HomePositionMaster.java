 ...
 * Created on 2024-06-19 ( Date ISO 2024-06-19 - Time 16:52:42 )
 * Generated by Telosys Tools Generator ( version 3.3.0 )
 */

/*
 * Created on 2024-06-19 ( 16:52:42 )
...
private static final long serialVersionUID = 1L;
    ...
    @Column(name="ADMIN_LOGIN_ID", length=50)
    ...
    @Column(name="ADMIN_REFERRAL_STATUS", length=2)
    private String     adminReferralStatus ;

    @Column(name="REFERRAL_DESCRIPTION", length=400)
    ...
    @Column(name="APPR_CAN_REMARKS", length=400)
    ...
    @Column(name="SUMMARY_REMARKS", length=1000)
    ...
    @Column(name="RENEWAL_STATUS", length=100)
    ...
    @Column(name="CORE_INTG_REMARKS", length=800)
    ...
    @Column(name="CUST_REJECT_REMARKS", length=800)
    ...
    @Column(name="ADD_CONDITION", length=800)
    private String     addCondition ;

    @Column(name="ORANGE_CARDURL", length=800)
    ...
    private String     referalRemaks ;

    @Column(name="REFERAL_TYPES", length=100)
    ...
    @Column(name="COMMISSION_MODIFY_YN", length=100)

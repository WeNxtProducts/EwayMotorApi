 ...
 * Created on 2024-06-19 ( Date ISO 2024-06-19 - Time 16:53:06 )
...
private static final long serialVersionUID = 1L;
    ...
    @Id
    @Column(name="OA_CODE", nullable=false, length=20)
    ...
    @Column(name="TAX_EXEMPTED_YN", length=10)
    ...
    @Column(name="BROKER_LOGO", length=100)
    private String     brokerLogo ;

    @Column(name="ID_TYPE", length=200)
    private String     idType ;

    @Column(name="ID_TYPE_DESC", length=200)

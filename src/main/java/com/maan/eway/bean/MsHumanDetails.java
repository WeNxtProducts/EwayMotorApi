...
private static final long serialVersionUID = 1L;
    ...
    @Column(name="ANNUAL_AGGREGATE")
    private BigDecimal     annualAggregate ;

    @Column(name="PRODUCT_TURNOVER")
    private BigDecimal     productTurnover ;

    @Column(name="ANNUAL_AGGREGATE_LC")
    private BigDecimal     annualAggregateLc ;

    @Column(name="PRODUCT_TURNOVER_LC")
    private BigDecimal     productTurnoverLc ;
    ...
    @Column(name="RATING_RELATION_ID", length=10)

...
*/
	...
	public ResponseEntity<CommonRes> getPersonalAccList(@RequestBody  EserviceCommonGetAllByRefNo req) {
		...
		@ApiOperation(value = "This Api For Check The Validations", notes = "Validation Api")
		@RequestMapping(value = "/validations", method = RequestMethod.POST)
		public ResponseEntity<ValidationRes> checkLoginId(@RequestBody ValidationRequest req ) throws Exception {

			return entityService.checkLoginId(req);
